...
def load_config():
    ...
    config_dict = {
        ...
        "LIVEKIT": {
            ...
            "room_name": config.get('LIVEKIT', 'room_name', fallback='tars-room'),
            "participant_identity": config.get('LIVEKIT', 'participant_identity', fallback='tars-pi'),
            "publish_camera": config.getboolean('LIVEKIT', 'publish_camera', fallback=True),
            "camera_fps": config.getint('LIVEKIT', 'camera_fps', fallback=5),
            ...
            "wake_word_model": config.get('LIVEKIT', 'wake_word_model', fallback='hey_mycroft'),
